...
(function () {
  ...
  function updateHero(d) {
    ...
    for (const [id,v] of Object.entries(m)) { const e=document.getElementById(id); if(e) { if(typeof v==='number') e.dataset.countTo=v; e.textContent=typeof v==='number'?fmt(v):v; } }
  }
  ...
  function updateDash(d) {
    ...
    for (const [id,v] of Object.entries(m)) { const e=document.getElementById(id); if(e){ if(typeof v==='number') e.dataset.countTo=v; e.textContent=typeof v==='number'?fmt(v):v; e.classList.remove('skeleton'); } }
